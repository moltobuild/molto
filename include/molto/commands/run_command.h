...
/* Execute `molto run [--profile <name>] [-- <args...>]`: build the project in
   the current directory and, on success, run its binary, forwarding
...
[[nodiscard]] int run_command_run(const char *requested_profile,
